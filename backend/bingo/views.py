...
def get_game_info(request, game_id, tg_id):
    try:
        ...
        if game.status == 'ENDED':
            ...
            if winner_user and winner_user.real_name: resp['winner'] = winner_user.real_name
            else: resp['winner'] = game.winner_username.replace('tg_', '') if game.winner_username else "PLAYER"
            ...
            try:
                if game.winner_username:
                    ...
                    winning_card_num = None; winning_board = None
                    called_set = set(game.called_numbers); called_set.add("FREE")
                    ...
                    if winning_card_num:
                        resp['winning_card'] = winning_card_num; resp['winning_board'] = winning_board
            except: pass
