...
async def game_dealer(game_id):
    await asyncio.sleep(300) # 5 Min Lobby wait
...
async def start(update: Update, context):
    ...
    kbd.append([InlineKeyboardButton("💵 10", callback_data="r_10"), InlineKeyboardButton("💵 20", callback_data="r_20"), InlineKeyboardButton("💵 40", callback_data="r_40")])
